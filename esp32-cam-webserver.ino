...
// Start time for restarting every 6 Hours
...
#define RESTART_TIMER 1800000
// #define RESTART_TIMER 150000
...
void loop() {
  ...
  if(current_time>RESTART_TIMER)ESP.restart();
  if (accesspoint) {
